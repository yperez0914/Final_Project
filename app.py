...
def createUser(dates, zipcode):
    ...
    collection.insert_one(history_df)
    print("data uploaded")

#Route to show second page (forecast)
"""
HTML & JS that loads data from the next route
"""

#Route to load date, perform ML, give predictions
"""
Import data from Mongo, perform ML, make predictions, return JSONIFY data
"""
